...
let cartArr = JSON.parse(localStorage.getItem('cartData')) || [{
    productName: 'Tronsmart Force/Mega/T6/T6 Plus/T6 Plus Upgraded Carrying Case Portable Travel Bag Protective Case',
    imageUrl: 'https://img.gkbcdn.com/p/2019-03-16/tronsmart-force-mega-t6-t6-plus-speaker-carry-case-1571991604256._w280_.jpg',
    offerPrice: '965.52',
    shipFrom: 'China'
}, {
    productName: 'Tronsmart Force/Mega/T6/T6 Plus/T6 Plus Upgraded Carrying Case Portable Travel Bag Protective Case',
    imageUrl: 'https://img.gkbcdn.com/p/2020-01-09/Tronsmart-element-T6-plus-Upgrade-Black-895558-._w280_.jpg',
    offerPrice: '965.52',
    shipFrom: 'China'
}, {
    productName: 'ronsmart Force/Mega/T6/T6 Plus/T6 Plus Upgraded Carrying Case Portable Travel Bag Protective Case',
    imageUrl: 'https://img.gkbcdn.com/p/2020-01-09/Tronsmart-element-T6-plus-Upgrade-Black-895558-._w280_.jpg',
    offerPrice: '965.52',
    shipFrom: 'USA'
}, {
    productName: 'Tonsmart Force/Mega/T6/T6 Plus/T6 Plus Upgraded Carrying Case Portable Travel Bag Protective Case',
    imageUrl: 'https://img.gkbcdn.com/p/2020-01-09/Tronsmart-element-T6-plus-Upgrade-Black-895558-._w280_.jpg',
    offerPrice: '96.52',
    shipFrom: 'India'
}, {
    productName: 'Trosmart Force/Mega/T6/T6 Plus/T6 Plus Upgraded Carrying Case Portable Travel Bag Protective Case',
    imageUrl: 'https://img.gkbcdn.com/p/2020-01-09/Tronsmart-element-T6-plus-Upgrade-Black-895558-._w280_.jpg',
    offerPrice: '965.52',
    shipFrom: 'India'
}, {
...
function showCart(cartArr) {
    ...
    cartArr.forEach(function (ele) {
        ...
        for (var i = 0; i < dataArr.length; i++) {
            let obj = dataArr[i];
            if (obj.imageUrl === ele.imageUrl && obj.productName === ele.productName && obj.offerPrice === ele.offerPrice && obj.shipFrom === ele.shipFrom) {
                flag = true;
                break;
            }
        }
    ...
    for (let country in cartData) {
        ...
        cartData[country].uniqueCartItems.forEach((ele, index) => {
            ...
            price.innerText = `₹ ${ele.offerPrice}`
            td4.append(price);
            ...
            tPrice.innerText = `₹ ${Math.round((+(ele.offerPrice) * (+(cartData[country].itemsQuantity[index]))) * 100) / 100}`
            td6.append(tPrice);
            ...
            delet.addEventListener('click', () => {
                ...
                document.querySelector('#del button:last-child').addEventListener('click', () => {
                    document.querySelector('#delBox').style.display = 'none';
                })
                document.querySelector('#del button:first-child').addEventListener('click', () => {
                    document.querySelector('#delBox').style.display = 'none';
                    deleteItem(ele);
                })
            })
...
function showPrice() {
    ...
    if (flag) {
        ...
        let counts = document.querySelectorAll(`#${id}>tbody>tr>td:nth-child(3)>p>span:nth-child(2)`);
    ...
    document.querySelector('span>b+b').innerText = '₹ ' + Math.round(totalPrice*100)/100;
}
...
function checkoutToPay (){
    ...
    let prices = document.querySelectorAll(`#${id}>tbody>tr>td:nth-child(4)`);
    let counts = document.querySelectorAll(`#${id}>tbody>tr>td:nth-child(3)>p>span:nth-child(2)`);
    let image = document.querySelectorAll(`#${id}>tbody>tr>td:nth-child(1)>img`)
